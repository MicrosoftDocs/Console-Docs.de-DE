...
| ESC \[ &lt; n &gt; F | CPL | Vorherige Cursor Zeile | Cursor &lt; nach oben n &gt; Zeilen von der aktuellen Position |
...
> [!TIP]
> Die Aktivierungs Sequenzen enden in einem Kleinbuchstaben-H-Zeichen ( `h` ), und die Deaktivierungs Sequenzen enden in einem Kleinbuchstaben-L-Zeichen ( `l` ).
...
| ESC \[ &lt; n &gt; L | IL | Zeile einfügen | Fügt &lt; n &gt; Zeilen an der Cursorposition in den Puffer ein. Die Zeile, in der sich der Cursor befindet, und die darunter liegenden Zeilen werden nach unten verschoben. |
...
> [!NOTE]
>Left <kbd>STRG</kbd> + right <kbd>alt</kbd> wird als AltGr behandelt. Wenn beide angezeigt werden, werden Sie entfernt, und der Unicode-Wert des vom System dargestellten Zeichens wird an das Ziel übermittelt. Das System übersetzt AltGr-Werte vorab gemäß den aktuellen System Eingabeeinstellungen.
...
> [!NOTE]
>Im vorherigen Beispiel ist die Zeichenfolge " `\x1b[31m` " die Implementierung von **ESC \[ &lt; n &gt; m** mit &lt; n &gt; 31.
